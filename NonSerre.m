...
for i->G in groups do
    ...
    if b_borel then
        Include(~borel, labels[i-1]);
    end if;
    if b_ns then
        Include(~nonsplit, labels[i-1]);
    end if;
    if b_ex then
        Include(~ex, labels[i-1]);
    end if;
    if b_sp then
        Include(~split, labels[i-1]);
    end if;
    if b_disc then
        Include(~disc, labels[i-1]);
    end if;
    if b_ent then
        Include(~entanglement, labels[i-1]);
    end if;
    if b_gal3 then
        Include(~gal3, labels[i-1]);
    end if;
end for;
print "Borel:", borel;
...
/*
Borel: { 8.16.0.a.1, 12.36.0.j.1, 20.24.1.g.1, 6.12.0.a.1, 8.24.0.t.1, 4.8.0.b.1, 16.16.0.a.1, 25.30.0.a.1, 16.48.1.cg.1, 16.48.1.ch.1, 8.24.0.bq.1, 4.2.0.a.1, 21.63.1.a.1, 12.36.0.h.1, 24.36.1.fw.1, 20.20.1.c.1, 8.12.0.v.1, 30.30.1.a.1, 16.48.0.i.1, 6.18.0.b.1, 8.24.0.be.1, 44.24.2.a.1, 13.91.3.a.1, 7.28.0.a.1, 8.12.0.h.1, 12.48.1.q.1, 28.64.3.b.1, 8.12.0.z.1, 8.12.0.t.1, 8.24.0.q.1, 12.32.1.b.1, 16.64.2.a.1, 16.16.0.b.1, 3.4.0.a.1, 8.24.0.bi.1, 16.48.1.de.1, 12.24.1.h.1, 24.48.1.mk.1, 16.24.0.g.1, 12.24.0.g.1, 4.6.0.d.1, 9.9.0.a.1, 4.12.0.a.1, 8.12.0.n.1, 4.24.0.b.1, 12.8.0.a.1, 28.16.0.a.1, 16.48.1.bv.1, 37.38.2.a.1, 14.16.0.a.1, 9.27.0.a.1, 18.24.0.c.1, 8.12.0.s.1, 4.4.0.a.1, 32.48.0.f.2, 8.8.0.a.1, 16.48.0.m.1, 8.24.0.bf.1, 4.6.0.c.1, 24.36.0.cj.1, 2.6.0.a.1, 8.24.0.bp.1, 12.18.0.l.1, 8.24.0.i.1, 12.36.0.k.1, 8.12.0.q.1, 30.120.7.e.1, 16.48.0.m.2, 120.48.3.c.1, 6.24.0.c.1, 12.36.0.e.1, 6.9.0.a.1, 16.48.0.h.1, 8.24.0.bj.1, 5.30.0.a.1, 25.75.2.a.1, 16.48.0.c.1, 16.24.1.l.1, 24.36.0.cg.1, 12.18.0.k.1, 12.24.1.g.1, 12.12.0.q.1, 4.6.0.a.1, 16.48.0.t.1, 4.12.0.b.1, 16.48.1.bq.1, 9.36.0.b.1, 1.1.0.a.1, 6.8.0.a.1, 8.24.0.f.1, 16.48.0.h.2, 8.12.0.w.1, 20.60.3.w.1, 168.64.3.a.1, 16.48.0.c.2, 6.24.0.a.1, 16.48.0.n.1, 8.24.0.bh.1, 16.48.1.df.1, 8.24.0.bc.1, 16.48.0.t.2, 16.48.1.cc.1, 12.24.0.f.1, 16.48.1.bl.1, 8.24.0.bt.1, 36.108.6.g.1, 5.15.0.a.1, 17.18.1.a.1, 6.6.0.b.1, 16.48.1.dc.1, 16.24.0.j.1, 10.30.0.a.1, 8.24.0.bn.1, 12.24.0.d.1, 120.72.3.gqp.1, 4.6.0.b.1, 8.24.0.bs.1, 2.2.0.a.1, 16.48.1.cs.1, 8.12.0.o.1 }
Nonsplit: { 20.60.3.w.1, 9.27.0.a.1, 13.14.0.a.1, 20.120.6.a.1, 30.120.7.e.1, 16.48.0.i.1, 7.21.0.a.1, 9.18.0.d.1, 12.32.1.b.1, 6.24.0.a.1, 16.48.0.m.2, 12.24.1.h.1, 6.36.0.a.1, 16.24.0.j.1, 5.10.0.a.1, 8.12.0.g.1, 12.36.0.h.1, 4.6.0.e.1, 8.24.0.bc.1, 9.12.0.a.1, 120.72.3.gqp.1, 12.36.0.j.1, 8.24.0.i.1, 3.12.0.a.1, 9.12.0.b.1, 12.48.1.q.1, 8.24.0.bo.1, 36.108.6.g.1, 2.3.0.a.1, 6.9.0.a.1, 12.8.0.a.1, 6.6.0.b.1, 24.36.1.gl.1, 21.63.1.a.1, 16.48.1.de.1, 24.36.0.cj.1, 12.12.0.q.1, 13.91.3.a.1, 15.45.1.a.1, 24.36.0.cg.1, 60.40.2.a.1, 32.48.0.f.1, 12.24.0.g.1, 168.64.3.a.1, 11.55.1.b.1, 12.24.1.g.1, 5.5.0.a.1, 12.24.0.f.1, 20.20.1.c.1, 3.4.0.a.1, 18.36.0.a.1, 15.30.1.a.1, 3.3.0.a.1, 36.24.0.b.1, 15.18.0.a.1, 10.18.0.a.1, 15.15.1.a.1, 20.10.0.a.1, 14.16.0.a.1 }
Ex: { 13.14.0.a.1, 4.12.0.d.1, 168.64.3.a.1, 13.91.3.a.1, 5.6.0.a.1, 10.10.0.a.1, 15.18.0.a.1, 120.48.3.c.1, 17.18.1.a.1, 27.36.0.a.1, 18.36.0.a.1, 100.100.4.d.1, 5.10.0.a.1, 18.24.0.b.1, 5.15.0.a.1, 44.24.2.a.1, 9.27.0.b.1 }
Split: { 7.8.0.a.1 }
Disc: { 4.12.0.a.1, 16.64.2.a.1, 120.72.3.gqp.1, 4.2.0.a.1, 2.2.0.a.1, 6.12.0.a.1, 168.64.3.a.1, 8.12.0.h.1, 8.24.0.bj.1, 8.24.0.q.1, 16.48.1.df.1, 12.18.0.l.1, 5.30.0.a.1, 12.36.0.e.1, 16.24.0.g.1, 9.27.0.b.1, 3.6.0.b.1, 12.24.1.h.1, 12.24.1.g.1, 25.30.0.a.1, 4.6.0.e.1, 16.48.1.cc.1, 4.8.0.b.1, 17.18.1.a.1, 18.24.0.b.1, 4.12.0.b.1, 10.30.0.a.1, 8.12.0.w.1, 16.48.1.dc.1, 32.48.0.f.2, 8.24.0.f.1, 16.48.0.m.1, 4.6.0.c.1 }
Entanglement: { 27.36.0.a.1, 36.36.1.e.1, 36.24.0.b.1, 6.18.0.b.1, 5.30.0.b.1, 20.120.6.a.1 }
Gal3: { 9.27.0.a.1 }
Only Borel: { 17.18.1.a.1, 13.91.3.a.1, 8.12.0.z.1, 16.24.1.l.1, 24.48.1.mk.1, 4.6.0.d.1, 4.12.0.b.1, 9.36.0.b.1, 16.48.0.c.2, 6.12.0.a.1, 16.16.0.a.1, 12.24.1.h.1, 16.48.1.dc.1, 10.30.0.a.1, 8.12.0.q.1, 8.12.0.n.1, 28.64.3.b.1, 16.48.1.bv.1, 37.38.2.a.1, 8.24.0.bf.1, 25.30.0.a.1, 4.8.0.b.1, 24.36.1.fw.1, 12.36.0.k.1, 12.24.1.g.1, 120.48.3.c.1, 16.48.0.n.1, 8.24.0.bq.1, 12.24.0.d.1, 8.8.0.a.1, 8.24.0.bn.1, 28.16.0.a.1, 32.48.0.f.2, 4.12.0.a.1, 8.24.0.bj.1, 6.18.0.b.1, 25.75.2.a.1, 8.12.0.t.1, 4.6.0.c.1, 8.24.0.f.1, 7.28.0.a.1, 6.8.0.a.1, 9.27.0.a.1, 8.24.0.be.1, 20.24.1.g.1, 2.2.0.a.1, 4.24.0.b.1, 168.64.3.a.1, 16.48.0.t.1, 16.48.0.m.1, 8.24.0.q.1, 120.72.3.gqp.1, 1.1.0.a.1, 16.64.2.a.1, 12.18.0.l.1, 4.2.0.a.1, 8.24.0.bt.1, 16.24.0.g.1, 8.24.0.bp.1, 8.24.0.bi.1, 4.4.0.a.1, 16.48.1.cs.1, 12.36.0.e.1, 5.30.0.a.1, 16.48.0.t.2, 9.9.0.a.1, 8.12.0.w.1, 4.6.0.b.1, 8.12.0.s.1, 8.12.0.h.1, 8.24.0.t.1, 16.48.1.cg.1, 8.16.0.a.1, 44.24.2.a.1, 16.48.1.cc.1, 18.24.0.c.1, 16.48.0.h.1, 2.6.0.a.1, 12.18.0.k.1, 8.24.0.bs.1, 8.24.0.bh.1, 16.48.1.df.1, 30.30.1.a.1, 5.15.0.a.1, 4.6.0.a.1, 16.48.1.ch.1, 16.16.0.b.1, 8.12.0.v.1, 8.12.0.o.1, 16.48.1.bl.1, 16.48.0.h.2, 6.24.0.c.1, 16.48.0.c.1, 16.48.1.bq.1 }
Only Nonsplit: { 5.5.0.a.1, 9.12.0.b.1, 9.12.0.a.1, 15.45.1.a.1, 10.18.0.a.1, 12.24.1.g.1, 15.15.1.a.1, 8.12.0.g.1, 120.72.3.gqp.1, 12.24.1.h.1, 36.24.0.b.1, 11.55.1.b.1, 20.10.0.a.1, 2.3.0.a.1, 24.36.1.gl.1, 18.36.0.a.1, 8.24.0.bo.1, 4.6.0.e.1, 9.18.0.d.1, 60.40.2.a.1, 5.10.0.a.1, 32.48.0.f.1, 13.14.0.a.1, 15.30.1.a.1, 6.36.0.a.1, 3.3.0.a.1, 15.18.0.a.1, 168.64.3.a.1, 3.12.0.a.1, 20.120.6.a.1, 13.91.3.a.1, 7.21.0.a.1 }
Only Ex: { 168.64.3.a.1, 4.12.0.d.1, 13.14.0.a.1, 13.91.3.a.1, 5.6.0.a.1, 10.10.0.a.1, 15.18.0.a.1, 17.18.1.a.1, 27.36.0.a.1, 18.36.0.a.1, 100.100.4.d.1, 5.10.0.a.1, 18.24.0.b.1, 9.27.0.b.1 }
Only Split: { 7.8.0.a.1 }
Only Disc: { 168.64.3.a.1, 4.6.0.e.1, 9.27.0.b.1, 12.24.1.g.1, 17.18.1.a.1, 3.6.0.b.1, 12.24.1.h.1, 18.24.0.b.1, 120.72.3.gqp.1 }
Only Entanglement: { 27.36.0.a.1, 36.36.1.e.1, 36.24.0.b.1, 5.30.0.b.1, 20.120.6.a.1 }
Only Gal3: { 9.27.0.a.1 }
*/