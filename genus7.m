//The genus 7 curve is an abelian cover of 45.54.2.c.1 with j = 2^6 and j = -2^{6}* 719^{3}
...
// second genus 7 curve is abelian cover of  30.60.4.a.1
// Canonical model
